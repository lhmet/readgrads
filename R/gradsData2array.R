...
#' @gradsData the grads data, object is generated by \code{\link{readGradsFile}}.
#' @ctlparams the parameters of the grads data, object is generated by \code{\link{parseCTLfile}}.
